...
<html lang="ko">
 <head>
  ...
  <link rel="stylesheet" href="../../../css/pantheon/common/main.css"> 
  ...
  <link rel="stylesheet" href="../../../css/pantheon/common/font-awesome.css"> 
  <link rel="stylesheet" href="../../../css/pantheon/common/axicon.css"> 
        ...
        <div class="mainConInner">
            ...
            <section class="conBox100 conBox">
                <div class="conBoxInner">
                    ...
                    <article class="mgT16">
                        <!-- 에이유아이 그리드가 이곳에 생성 -->
                        <div id="grid_wrap2" class="gridHeiSz10 grid_wrap tb01_2"></div>
                        <!-- 그리드 페이징 네비게이터 -->
                    ...
                    <section class="conSbtR50 conSbtR">
                        ...
                        <div class="conSbtLn">
                            ...
                            <article class="mgT16">
                                ...
                                <!-- 그리드 페이징 네비게이터 -->
                                <div id="grid_paging8" class="aui-grid-paging-panel my-grid-paging-panel"></div>
                            </article>
                            <!-- 그리드 끝 -->
                    ...
                    <article class="tab_list">
                        <div class="tab_sub1 tab_sub">
                            ...
                            <article class="mgT16">
                                ...
                                <!-- 그리드 페이징 네비게이터 -->
                                <div id="grid_paging10" class="aui-grid-paging-panel my-grid-paging-panel"></div>
                            </article>
                            <!-- 그리드 끝 -->
