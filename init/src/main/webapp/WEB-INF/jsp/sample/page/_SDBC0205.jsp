...
var testData =[
{
  ...
  "TEST":"Creatinine",
  "Unit":"mg/dL",
  "Normal low range":"1.0",
  "Normal high range":"2.0",
  "Result":"3.0",
  "Comments":"NCS",
  "Deleted":"N"
}, {
...
var myGridOption = {
  ...
  columnLayout : [{
    ...
    dataField : "Normal low range",
    headerText : "Normal low range",
    width : 140
  },{
    dataField : "Normal high range",
    headerText : "Normal high range",
    width : 140
  },{
    dataField : "Result",
    headerText : "Result",
				...
				<div class="conBoxInner" style="min-height:900px;">
					...
					<div class="button_tab_01">
						<ul>
							...
							<li id="" class="port_back tab_menu">TEST</li>
					...
					<ul class="mgT20">
					    <li class="accordion_02">
					    	<a href="#void" class="close">TEST No.1</a>
