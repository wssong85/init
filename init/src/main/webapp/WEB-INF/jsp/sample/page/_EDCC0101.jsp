					...
					<form name="searchForm" id="">
						...
						<article class="mgT10" style="overflow:hidden;">
							...
							<div class="conTitBtnR">									
								<input type="button" value="Patient 등록" onclick="">
								<input type="button" value="연구 종료 요청" onclick="">
								<input type="button" value="설정" onclick="">
							</div>
						</article>
