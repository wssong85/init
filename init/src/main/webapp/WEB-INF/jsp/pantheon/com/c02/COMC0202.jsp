...
var grEdcCrMdic = {
 	...
 	binding: function() {
		...
		AUIGrid.bind(me.id, 'selectionChange', function(e) {
			grEdcCrAtc.proxy.param['DICARY_VER'] = e.selectedItems[0].item['DICARY_VER'];
			grEdcCrAtc.proxy.param['DICARY_SE_CODE'] = e.selectedItems[0].item['DICARY_SE_CODE'];
			grEdcCrAtc.load();
		});
 	},
 	load: function() {
...
var grEdcCrAtc = {
 	...
 	proxy: {
 		url: "<c:url value='/com/c01/selectEdcCrAtcByDicaryVer.do'/>",
 		param: {},
 		type: 'post',
 		dataType: 'json',
 		paging: true,
 	...
 	columnLayout : [{
 		...
 		headerText : "FIVE_T_LVL",
 		filter : {
 			showIcon : true
 		}
 	},{
 		dataField : "FOUR_T_LVL",
 		headerText : "FOUR_T_LVL",
 		filter : {
 			showIcon : true
 		}
 	},{
 		dataField : "THREE_T_LVL",
 		headerText : "THREE_T_LVL",
 		filter : {
 			showIcon : true
 		}
 	},{
 		dataField : "TWO_T_LVL",
 		headerText : "TWO_T_LVL",
 		filter : {
 			showIcon : true
 		}
 	},{
 		dataField : "ONE_T_LVL",
 		headerText : "ONE_T_LVL",
 		filter : {
 			showIcon : true
 		}
 	}],
...
$(function(){
	...
	$('#btnDownload').click(function(){
		window.open("<c:url value='/data/excel/atc.xlsx'/>");
	});
	
	// 팝업레이어
	$('.popup_01').click(function(){
		mkLayerPopupOpen("<c:url value='/com/c02/COMC0206.do'/>", {
...
$(window).resize(function() {
	...
	if(grEdcCrAtc && grEdcCrAtc.id) {
		AUIGrid.resize(grEdcCrAtc.id);
	}
});
</script>
...
<body>
<div id="wrap">
<c:import url="/com/topHeader.do?MODULE_CODE=COM&MENU_ID=COMC0202&UPPER_MENU_ID=COMC" charEncoding="utf-8"/>
            ...
            <section class="conBox100 conBox">
				<div class="conBoxInner">
					...
					<div id="tab" class="tab tab01 mgT16">
						<ul>
							<li id="tab_01" class="tab_menu">MedDRA</li>
							<li id="tab_02" class="port_back tab_menu" onClick="">ATC</li>
            ...
            <section class="conBox100 conBox">
				<div class="conBoxInner">
                    ...
                    <article class="conTitBox">
 					...
 					<article class="mgT16">
                        <div id="grEdcCrAtc" class="gridHeiSz10 grid_wrap tb01_2"></div>
                        <div id="pgEdcCrAtc" class="aui-grid-paging-panel my-grid-paging-panel"></div>
                    </article>
