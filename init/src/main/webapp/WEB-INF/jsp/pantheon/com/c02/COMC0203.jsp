...
var grEdcCrMdic = {
 	...
 	binding: function() {
		...
		AUIGrid.bind(me.id, 'selectionChange', function(e) {
			grEdcCrWhoart.proxy.param['DICARY_VER'] = e.selectedItems[0].item['DICARY_VER'];
			grEdcCrWhoart.proxy.param['DICARY_SE_CODE'] = e.selectedItems[0].item['DICARY_SE_CODE'];
			grEdcCrWhoart.load();
		});
 	},
 	load: function() {
...
var grEdcCrWhoart = {
 	...
 	failCount: 0,
 	div: {
 		gridDiv: '#grEdcCrWhoart',
 		paging: {
 			pagingDiv: 'pgEdcCrWhoart',
 			totalRowCount: 500,
 			rowCount: 20,
 			pageButtonCount: 5,
 			currentPage: 1,
 	...
 	proxy: {
 		url: "<c:url value='/com/c01/selectEdcCrWhoartByDicaryVer.do'/>",
 		param: {},
 		type: 'post',
 		dataType: 'json',
 		paging: true,
...
$(function(){
	...
	$('#btnDownload').click(function(){
		window.open("<c:url value='/data/excel/whoart.xlsx'/>");
	});
	
	// 팝업레이어
	$('.popup_01').click(function(){
		mkLayerPopupOpen("<c:url value='/com/c02/COMC0207.do'/>", {
...
$(window).resize(function() {
	...
	if(grEdcCrWhoart && grEdcCrWhoart.id) {
		AUIGrid.resize(grEdcCrWhoart.id);
	}
});
</script>
...
<body>
<div id="wrap">
<c:import url="/com/topHeader.do?MODULE_CODE=COM&MENU_ID=COMC0203&UPPER_MENU_ID=COMC" charEncoding="utf-8"/>
				...
				<div class="conBoxInner">
					...
					<div id="tab" class="tab tab01 mgT16">
						<ul>
							...
							<li id="tab_03" class="port_back tab_menu" onClick="">WHOART</li>
            ...
            <section class="conBox100 conBox">
				<div class="conBoxInner">
                    ...
                    <article class="conTitBox">
 					...
 					<article class="mgT16">
                        <div id="grEdcCrWhoart" class="gridHeiSz10 grid_wrap tb01_2"></div>
						<div id="pgEdcCrWhoart" class="aui-grid-paging-panel my-grid-paging-panel"></div>
                    </article>
