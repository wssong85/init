 	...
 	binding: function() {
 		...
 		AUIGrid.bind(me.id, 'cellClick', function(event) {
 			if(AUIGrid.getSelectedIndex(me.id)[1] == 2) {
				...
				document.frCmNotice.action = "<c:url value='/com/anonymous/COMZ0402.do'/>";
...
<form:form commandName="frCmNotice" name="frCmNotice"  method="post">
		...
		<section class="conBox100 conBox " style="height:auto;">
			...
			<div class="conBoxInner">
				...
				<table>
					...
					<tr>
						<th style="width:70px">
							<label style="width:65px;text-align:right;display:block;float:left;">기간 : </label>
						</th>
	...
	<!-- 						<input type="button" id="btnCmNoticeCreate" class="btn mgL3" value="신규"> -->
						</td>
					</tr>
					</tbody>
				</table>
