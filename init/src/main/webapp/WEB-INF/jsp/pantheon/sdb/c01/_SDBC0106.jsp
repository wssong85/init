...
$(function(){
	...
	$('#btnAdd').click(function(){
		window.location.href='/sdb/c01/_SDBC0107.do';
	});
});
...
var grLiterature_list = {
 	...
 	binding: function() {
	  ...
	  createPagingNavigator: function(goPage) {
		...
		retStr += "<a href='javascript:grLiterature_list.moveToPage(1)'><span class='aui-grid-paging-number aui-grid-paging-first'> << </span></a>";

		// 이전
		retStr += "<a href='javascript:grLiterature_list.moveToPage(" + prevPage + ")'><span class='aui-grid-paging-number aui-grid-paging-prev'> < </span></a>";

		for (var i=(prevPage+1), len=(me.div.paging.pageButtonCount+prevPage); i<=len; i++) {
			if (goPage == i) {
				retStr += "<span class='aui-grid-paging-number aui-grid-paging-number-selected'>" + i + "</span>";
			} else {
				retStr += "<a href='javascript:grLiterature_list.moveToPage(" + i + ")'><span class='aui-grid-paging-number'>";
				retStr += i;
				retStr += "</span></a>";
			}
		...
		// 다음
		retStr += "<a href='javascript:grLiterature_list.moveToPage(" + nextPage + ")'><span class='aui-grid-paging-number aui-grid-paging-next'> > </span></a>";

		// 마지막
		retStr += "<a href='javascript:grLiterature_list.moveToPage(" + me.div.paging.totalPage + ")'><span class='aui-grid-paging-number aui-grid-paging-last'> >> </span></a>";
		retStr += "</span>";
