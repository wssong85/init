...
$(function(){
	...
	AUIGrid.setGridData(grSpontaneous_list.id, []);                                                                           
...
function btnInit(){
	...
	$('#btnExcel').click(function() {
		...
		var data = AUIGrid.getGridData(grSpontaneous_list.id);
		
		if(data.length) {
			var exportProps = {
					fileName : "Spontaneous"
			};
			AUIGrid.setProperty(grSpontaneous_list.id, "exportURL", '/com/z02/downloadAuiGridFile.do');
			AUIGrid.exportToXlsx(grSpontaneous_list.id, true, exportProps);
		} else {
