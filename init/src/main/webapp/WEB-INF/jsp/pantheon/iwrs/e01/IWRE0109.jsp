					...
					<article class="mgT5">
						<table class="tb004">
							...
							<tbody>
								<tr>
									<th>
										<c:forEach items="${ EDC053 }" var="list" varStatus="status">
											<input type="radio" id="end_type_${ status.count }" name="end_type" value="${ list.CODE }" />
								...
								<tr>
									<td>
										<textarea style="width: 100%; height: 50px;" id="txtResn" valireqire="Query 종료"></textarea>
									</td>
								</tr>
							</tbody>
						</table>
