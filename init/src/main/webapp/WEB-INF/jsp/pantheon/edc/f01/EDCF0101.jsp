...
var grid_siteList = {
	 	...
	 	columnLayout : [{ 
							...
							headerText : "SDV_COMPT_STTUS_CODE",
							editable : false,
							visible : false
						},{ 
							dataField : "INSTT_NM",
...
$(function(){
	...
	$('#btnSearch').click(function(){
		...
		grid_siteList.proxy.param = params;
		grid_siteList.load();
	});
});
...
function fn_sdvPrcss(v){
	...
	var items = AUIGrid.getCheckedRowItems(grid_siteList.id);
	if(items.length <= 0){
		alert("Site를 선택해 주세요.");
		return;
	}
	...
	// 선택된 행 아이템들(배열)		
	var editedItems = AUIGrid.getCheckedRowItems(grid_siteList.id);
	...
	$.ajax({
		  ...
		  success : function(data, textStatus, jqXHR) {
			  if(data.success) {					
				  ...
				  AUIGrid.removeAjaxLoader(grid_siteList.id);
				  alert(data.message);
			  }
		  }, 
...
window.onresize = function() {
	if (grid_siteList.id !== "undefined") {
		AUIGrid.resize(grid_siteList.id);
	}
};
</script>
...
<body>
<div id="wrap">
<c:import url="/com/topHeader.do?MODULE_CODE=EDC&MENU_ID=EDCF0101&&UPPER_MENU_ID=EDCF" charEncoding="utf-8"/>
<c:import url="/com/lnb.do?MODULE_CODE=EDC&MENU_ID=EDCF0101&&UPPER_MENU_ID=EDCF" charEncoding="utf-8"/>
	<section id="mainCon">
            ...
            <section class="conBox100 conBox">
				<div class="conBoxInner">
					<div id="tab" class="tab tab01 mgT16">
						<ul>
							<li id="tab_01" class="port_back tab_menu">Site</li>
					...
					<article style="overflow:hidden;">
 					...
 					<article class="mgT16">
                        <div id="grid_siteList" class="gridHeiSz15 grid_wrap tb01_2"></div>
