...
<script type="text/javascript">
	...
	var g_TaskSn   = '${TASK_SN}';//${loginMap.TASK_SN};
			...
			binding: function() {
				...
				AUIGrid.bind(me.id, "cellClick", function(event) {
		 		...
		 		AUIGrid.bind(me.id, 'cellDoubleClick', function(e) {
					e.item.TASK_END_AT = 'Y';
		 			AUIGrid.addRow(grid_option02.id, e.item, 'first');
	...
	var grid_option02 = {
			...
			binding: function() {
				...
				AUIGrid.bind(me.id, 'cellDoubleClick', function(e) {
					e.item.TASK_END_AT = 'N';
		 			AUIGrid.addRow(grid_option01.id, e.item, 'first');
		 			AUIGrid.removeRow(me.id, 'selectedIndex');
		 		});
	...
	$(function(){
		...
		$('#btnSave').click(function(){
			...
			var data1 = AUIGrid.getGridData(grid_option01.id);
			...
			var data2 = AUIGrid.getGridData(grid_option02.id);
	...
	window.onresize = function() {
		if (grid_option01.id !== "undefined") {
			AUIGrid.resize(grid_option01.id);
		}
		if (grid_option02.id !== "undefined") {
	            ...
	            <section class="conBox50 conBox" style="float: left; width:48%; position:relative;">
	                <div class="conBoxInner">
	                    ...
	                    <article class="conTitBox">
	                        <h5><spring:message code="edc.gr.title.TASK_LIST" /></h5>	<!-- 종료과제목록-->
	                    </article>
	                    <!-- 그리드 시작 -->
	                    <article class="mgT16">
...
.big_arrow_btn_02 {  transition-duration:0s !important; padding:14px 5px 15px 5px !important; height:60px !important; background:#4c55a4 !important;  font-size: 20px !important; }
	            ...
	            <section class="conBox50 conBox" style="float: right; width:48%;  ">
	                <div class="conBoxInner">
	                    ...
	                    <!-- 컨텐츠 타이틀 시작-->
	                    <article class="conTitBox">
	                        <h5><spring:message code="edc.gr.title.TASK_END_LIST" /></h5>	<!-- 종료과제목록-->
	                    </article>
	                    <!-- 컨텐츠 타이틀 끝-->
	                    <!-- 상단 그리드 오른쪽 메뉴 시작-->
	                    <article class="conTitBtnR">
	                        <input type="button" id="btnSave" class='save_01' title='<spring:message code="button.save" />' value='<spring:message code="button.save" />'>
	                    </article>
	                    <!-- 상단 그리드 오른쪽 메뉴 끝-->
