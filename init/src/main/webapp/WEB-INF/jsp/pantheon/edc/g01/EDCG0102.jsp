...
<script>
	...
	var grid_csList = {
		 	...
		 	proxy: {
				...
				param : {'TASK_SN':taskSn, 'DOMN_SE_CODE':'02'},
		 		type: 'post',
		 		dataType: 'json',
		 		paging: false,
		 		autoLoad: true
...
<body>
<div id="wrap">
<c:import url="/com/topHeader.do?MODULE_CODE=EDC&MENU_ID=EDCG0102&&UPPER_MENU_ID=EDCG" charEncoding="utf-8"/>
				...
				<div class="conBoxInner">
						<div id="tab" class="tab tab01 mgT16">
							<ul>
								...
								<li id="tab_03" class="port_back tab_menu"><spring:message code="edcg01.tab.PRE_JOIN_DRUG" /></li><!-- 선행/병용약물 -->
							</ul>
						</div>
