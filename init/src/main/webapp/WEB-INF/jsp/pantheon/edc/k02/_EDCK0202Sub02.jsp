			...
			<div class="popup_conBoxInner">
							...
							<tbody>
								<tr>
									...
									<td style="padding:7px 6px 0px 7px;">
										<textarea id="CHANGE_RESN" rows="4" style="width:100%;" name="CHANGE_RESN">${ detail.CHANGE_RESN }</textarea>
									</td>
								</tr>
								<tr>
									<th>적용방법</th>
				...
				<article class="mgT10">
					<div style="text-align:center">
						<input type="button" id="btnSave" value="저장" onclick="saveChangeReason()" />
