...
<script>
	...
	var grid_csList = {
		 	...
		 	proxy: {
				...
				param : {'TASK_SN':taskSn, 'DOMN_SE_CODE':domnSeCode},
		 		type: 'post',
		 		dataType: 'json',
		 		paging: false,
		 		autoLoad: true
...
// 											contentType : "application/json; charset=UTF-8",
	...
	$(document).ready(function(){
		...
		$('#btnPkgCoding').click(function(){
			var params = {};
			
			mkLayerPopupOpen("<c:url value='/edc/g01/popupEDCG0105.do' />", params);
...
<body>
<div id="wrap">
<c:import url="/com/topHeader.do?MODULE_CODE=EDC&MENU_ID=EDCG0101&&UPPER_MENU_ID=EDCG" charEncoding="utf-8"/>
            ...
            <section class="conBox100 conBox">
				<div class="conBoxInner">
						<div id="tab" class="tab tab01 mgT16">
							<ul>
								<li id="tab_01" class="port_back tab_menu"><spring:message code="edcg01.tab.CASE_HIST" /></li><!-- 병력 -->
								<li id="tab_02" class="tab_menu" onclick="fn_moveTab('EDCG0103');"><spring:message code="edcg01.tab.ADV_REACT" /></li><!-- 이상반응 -->
