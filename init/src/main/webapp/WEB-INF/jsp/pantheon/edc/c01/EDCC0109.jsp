...
<script type="text/javascript">
	var isChangePopup = false;
	var EDCC0109_grid = {
		id : '',
		div : {
			gridDiv : '#EDCC0109_grid',
			paging : {
				pagingDiv : '',
				totalRowCount : 500,
				rowCount : 10,
	...
	$(document).ready(function() {
		EDCC0109_grid.createGrid();
		EDCC0109_grid2.createGrid();
		EDCC0109_grid3.createGrid();

		var param = fn_serializeObject($("#frm_popup"));
		EDCC0109_grid.proxy.param = param;
		EDCC0109_grid.load();
		var layout = fn_makeCRFObject(EDCC0109_grid);
		makeLayoutInput(layout, "popup_crf_layout", EDCC0109_grid);
		
		EDCC0109_grid2.proxy.param = param;
		EDCC0109_grid2.load();
		fn_showComment(EDCC0109_grid2, "popup_crf_layout");

		EDCC0109_grid3.proxy.param = param;
		EDCC0109_grid3.load();
		showQuery(EDCC0109_grid3, "popup_crf_layout", 2);

		fn_inputControl("div_popup_btn", "frm_popup", "popup_crf_layout");
	...
	<div class="popup popup1 wd1200">
		<section class="conBox100 popup_conBox" style="margin: 0px;">
			<div class="popup_conBoxInner">
				...
				<article class="conTitBtnR" id="div_popup_btn">
					<button type="button" id="btn_reset" onclick="saveCRFPage('div_popup_btn' , 'frm_popup' , 'popup_crf_layout' ,'01', EDCC0109_grid, EDCC0109_grid2, EDCC0109_grid3 );">초기화</button>
					<button type="button" id="btn_temp_save" onclick="saveCRFPage('div_popup_btn' , 'frm_popup' , 'popup_crf_layout' ,'03', EDCC0109_grid, EDCC0109_grid2, EDCC0109_grid3 );">임시저장</button>
					<button type="button" id="btn_save" onclick="saveCRFPage('div_popup_btn' , 'frm_popup' , 'popup_crf_layout' ,'02', EDCC0109_grid, EDCC0109_grid2, EDCC0109_grid3 );">저장</button>
				</article>
				...
				<div id="EDCC0109_grid" class="gridHeiSz05 grid_wrap tb01_2 " style="display: none;"></div>
				<div id="EDCC0109_grid2" class="gridHeiSz05 grid_wrap tb01_2 " style="display: none;"></div>
				<div id="EDCC0109_grid3" class="gridHeiSz05 grid_wrap tb01_2 " style="display: none;"></div>
