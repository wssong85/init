...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		EDCK0209Sub02_grid.proxy.param = grid_param;
		EDCK0209Sub02_grid.createGrid();
	});
	function changeVariable() {
		var selectedItems = AUIGrid.getSelectedItems(EDCK0209Sub02_grid.id);
		...
		<section class="conBox100 popup_conBox" style="margin: 0px;">
			<div class="popup_conBoxInner">
				<div id="tab2" class="tab tab01">
					<ul>
						<li id="tab_menu1" class="tab_menu2" onclick="tapChangeVariable('EDCK0209Sub02');">Variable</li>
						<li id="tab_menu2" class="port_back2 tab_menu2">입력방식</li>
					</ul>
				</div>
				...
				<article class="mgT16">
					<div id="EDCK0209Sub02_grid" class="gridHeiSz04 grid_wrap tb01_2"></div>
				</article>
