...
<script type="text/javascript">
	...
	$(document).ready(function() {
		EDCC0111_grid.createGrid();
		EDCC0111_grid2.createGrid();
		EDCC0111_grid3.createGrid();
		EDCC0111_grid4.createGrid();

		var param = fn_serializeObject($("#frm_popup"));

		EDCC0111_grid.proxy.param = param;
		EDCC0111_grid.load();
		var layout = fn_makeCRFObject(EDCC0111_grid);
		makeLayoutSDV(layout, "popup_crf_layout", 2, EDCC0111_grid);

		EDCC0111_grid2.proxy.param = param;
		EDCC0111_grid2.load();
		fn_showComment(EDCC0111_grid2, "popup_crf_layout");

		EDCC0111_grid3.proxy.param = param;
		EDCC0111_grid3.load();
		showQuery(EDCC0111_grid3, "popup_crf_layout", 2, EDCC0111_grid);

		EDCC0111_grid4.proxy.param = param;
		EDCC0111_grid4.load();
		showSDV(EDCC0111_grid4, "popup_crf_layout");

		statusControl("popup_crf_layout");
	...
	<div class="popup popup1 wd1200">
		<section class="conBox100 popup_conBox" style="margin: 0px;">
			<div class="popup_conBoxInner">
				...
				<article class="conTitBtnR" id="div_popup_btn" style="margin-bottom: 8px;">
					<button type="button" id="btn_sdv" onclick="saveSDV('popup_crf_layout', EDCC0111_grid4);">SDV</button>
					<button type="button" id="btn_completion" onclick="saveCompletion('03', 'popup_crf_layout', EDCC0111_grid4);">SDV Completion</button>
					<button type="button" id="btn_completion2" onclick="saveCompletion('01', 'popup_crf_layout', EDCC0111_grid4);">SDV Completion 해제</button>
				</article>
				...
				<div id="EDCC0111_grid" class="gridHeiSz05 grid_wrap tb01_2 " style="display: none;"></div>
				<div id="EDCC0111_grid2" class="gridHeiSz05 grid_wrap tb01_2 " style="display: none;"></div>
				<div id="EDCC0111_grid3" class="gridHeiSz05 grid_wrap tb01_2 " style="display: none;"></div>
				<div id="EDCC0111_grid4" class="gridHeiSz05 grid_wrap tb01_2 " style="display: none;"></div>
