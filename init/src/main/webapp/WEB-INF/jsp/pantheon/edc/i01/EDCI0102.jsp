...
// 	 			alert("rowIndex : "+event.rowIndex + ", columnIndex : "+event.columnIndex+" clicked");
	...
	$(document).ready(function() {
		...
		$("#btnReqBlndRelisCnfm").click(function(){		//눈가림 해제 승인
			...
			if(sttBlnd == "02"){		//유지 상태인 경우 해제요청
				var param = new Object();
				mkLayerPopupOpen("/edc/i01/popupEDCI0104.do", param);
				fn_newForm();
			}else{
				alert("눈가림 상태가 '요청'인 건만 눈가림 해제 요청을 할 수 있습니다.");
			}
		});
		
		$("#btnCnfmHist").click(function(){		//승인이력
...
<div id="wrap">
<c:import url="/com/topHeader.do?MODULE_CODE=EDC&MENU_ID=EDCI0102&&UPPER_MENU_ID=EDCI" charEncoding="utf-8"/>
<c:import url="/com/lnb.do?MODULE_CODE=EDC&MENU_ID=EDCI0102&&UPPER_MENU_ID=EDCI" charEncoding="utf-8"/>
                ...
                <div class="conBoxInner">
                	<article style="overflow:hidden;">
	                    ...
	                    <div class="conTitBtnR">
							<input type="button" id="btnReqBlndRelisCnfm" value="눈가림해제 승인" >
							<input type="button" id="btnCnfmHist" value="승인 이력" >
	                    </div>
                	</article>
                    <article class="mgT16">
                        <!-- 에이유아이 그리드가 이곳에 생성 -->
