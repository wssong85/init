...
$(function() {
	...
	$("#textTaskNoSearch").keydown(function(event){		
		if(event.keyCode == 13){	
			taskNo = $("#textTaskNoSearch").val();
			tyCode = $("#btnTaskNoSearchModule").val();				
			gridTask.load();
	...
	$("#btnInstt").click(function(){
		if(currentRowIndex >= 0){
			var rowItem = AUIGrid.getItemByRowIndex("#gridTask", currentRowIndex);
 			returnTaskValue = {
 				 TASK_SN : rowItem.TASK_SN
	 			,TASK_NO : rowItem.TASK_NO
 			};
