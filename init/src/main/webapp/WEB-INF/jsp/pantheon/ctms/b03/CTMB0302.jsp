...
$(document).ready(function() {
	...
	$("#SummaryBtn").click(function(){
		$(location).attr("href","/ctms/b03/CTMB0301.do");
	});
	//버튼 클릭시 해당 모듈 이동
...
<body>
<c:import url="/com/topHeader.do?MODULE_CODE=CTMS&MENU_ID=CTMB0302&UPPER_MENU_ID=CTMB" charEncoding="utf-8"/>
