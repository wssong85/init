...
var myGridOption = {
		  ...
		  init: function(v1, v2) {
			  console.log("me.init()....");
		 		...
		 		param = {'CMMN_CLCODE':'CTM003', 'TASK_SN':g_TaskSn};
            ...
            <section class="conBox100 conBox">
				<div class="conBoxInner">
						...
						<div id="tab" class="tab tab01">
							<ul>
								<li id="tab_menu1" class="port_back tab_menu" onclick="fn_moveTab('CTML0101');">계획리스트</li>
								<li id="tab_menu2" class="tab_menu" onclick="fn_moveTab('CTML0102');">Milestone</li>
							</ul>
						</div>
						...
						<form id="frm" name="frm">
							<input id="TASK_SN" type="hidden" name="TASK_SN" value="${ TASK_SN }">
						</form>
