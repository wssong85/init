...
//Grid2 row Add 
  ...
  $("#btnSave").click(function(){
	  //////실시일 널값체크
	  if(!$("#day_01").val()){
		   alert("<spring:message code='ctmz0201.message.day01'/>");
		   $("#day_01").focus();
		   return;
	   }
	  //////실시일 형식 체크
  ...
  $("#btnApproval").click(function() {
		mkLayerPopupOpen('/com/z09/popupCOMZ0901.do', {
			'REQUST_NM': '<spring:message code="ctmz0201.title.report" />',
...
<body>
<div id="wrap">
<c:import url="/com/topHeader.do?MODULE_CODE=CTMS&MENU_ID=CTMZ0203&UPPER_MENU_ID=CTMZ" charEncoding="utf-8"/>
<c:import url="/com/lnb.do?MODULE_CODE=CTMS&MENU_ID=CTMZ0203&UPPER_MENU_ID=CTMZ" charEncoding="utf-8"/>
		...
		<div class="mainConInner">
            ...
            <section class="conBox100 conBox">
				<div class="conBoxInner" style="min-height:900px;">
					...
					<table class="tb001">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<input type="text" id="txtInputPlace" style="width:100%;">
								</td>
							</tr>
						</tbody>
					</table>
						...
						<tbody>
							<tr>
								...
								<td style="padding:10px; padding-bottom: 2px;">
									<textarea id="txtInputRemark" rows="3" style="width: 100%;" ></textarea>
								</td>
							</tr>
						</tbody>
					</table>
                    ...
                    <article class="conTitBox">
                        <h6>3. <spring:message code="ctms.title.Approval"/></h6>
                    </article>
