...
var visitReportGrid = {
	 	...
	 	proxy: {
	 		...
	 		param: {'TASK_SN' : g_taskSn, 'REPORT_SE':'Z05'},
	 		type: 'post',
	 		dataType: 'json',
	 		//페이징 true, false 로 지정
	 		paging: false,
...
window.onresize = function() {
	if (typeof visitReportGrid.id != "undefined") {
		AUIGrid.resize(visitReportGrid.id);
	}
}
</script>
...
<body>
<c:import url="/com/topHeader.do?MODULE_CODE=CTMS&MENU_ID=CTMZ0503&UPPER_MENU_ID=CTMZ" charEncoding="utf-8"/>
<c:import url="/com/lnb.do?MODULE_CODE=CTMS&MENU_ID=CTMZ0503&UPPER_MENU_ID=CTMZ" charEncoding="utf-8"/>
<section id="mainCon">
