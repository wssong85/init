...
var monitoringGrid = {
	 	id: 'monitoringGrid',
	 	div: {
	 		gridDiv: '#monitoringGrid'
	 	},
	 	proxy: {
	 		url: './selectMonitoringGrid.do',
...
$(window).resize(function(){
	if (monitoringGrid.id) {
		AUIGrid.resize(monitoringGrid.id);
	}	
});

$(document).ready(function() {
	monitoringGrid.createGrid();	
           ...
           <article class="mainTitBox">
            ...
            <section class="conBox100 conBox">
            	...
            	<article class="mainTitBox">
                    ...
                    <article class="mgT16">
                        <!-- 에이유아이 그리드가 이곳에 생성 -->
                         <div id="monitoringGrid" class="gridHeiSz17 grid_wrap tb01_2"></div>
                    </article>
                    <!-- 그리드 끝 -->
