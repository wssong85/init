...
var _user = {
	...
	var myGridOption = {
			  ...
			  //데이터 연계 옵션
			  proxy: {
			    url: '/ctms/v01/selectIRBBasicInfoList.do',//변경 /ctms/e01/
...
// 					checkSelection();
			  ...
			  init: function(v1, v2) {
			 		...
			 		$.ajax({
			 		    url: "/ctms/v01/selectIRBInitInfo.do",//변경 /ctms/e01/
			 		    type: me.proxy.type,
	...
	var myGridSub1 = {
			  ...
			  //데이터 연계 옵션
			  proxy: {
			    url: '/ctms/v01/selectIRBCttpcList.do',//변경 /ctms/e01/
			    param: {},
			    type: 'post',
			    dataType: 'json',
			    //페이징 true, false 로 지정
...
//g_comCode1List
	...
	var myGridSub2 = {
			  ...
			  //데이터 연계 옵션
			  proxy: {
			    url: '/ctms/v01/selectIRBDlbrtctList.do',//변경 /ctms/e01/
			    param: {},
			    type: 'post',
			    dataType: 'json',
			    //페이징 true, false 로 지정
...
// 	    			, width: 120
	...
	var myGridSub3 = {
			  ...
			  //데이터 연계 옵션
			  proxy: {
			    url: '/ctms/v01/selectIRBRsrcctist.do',//변경 /ctms/e01/
			    param: {},
			    type: 'post',
			    dataType: 'json',
			    //페이징 true, false 로 지정
...
// 	    			, width: 120
	...
	var myGridSub4 = {
			  ...
			  //데이터 연계 옵션
			  proxy: {
			    url: '/ctms/v01/selectIRBDlbrtList.do',//변경 /ctms/e01/
			    param: {},
			    type: 'post',
			    dataType: 'json',
			    //페이징 true, false 로 지정
...
// 	    			, width: 120
	...
	var myGridSub5 = {
			  ...
			  //데이터 연계 옵션
			  proxy: {
			    url: '/ctms/v01/selectIRBSaeList.do',//변경 /ctms/e01/
			    param: {},
			    type: 'post',
			    dataType: 'json',
			    //페이징 true, false 로 지정
...
// 	    			, width: 120
	...
	var myGridSub6 = {
			  ...
			  //데이터 연계 옵션
			  proxy: {
			    url: '/ctms/v01/selectIRBInfoList.do',//변경 /ctms/e01/
			    param: {},
			    type: 'post',
			    dataType: 'json',
			    //페이징 true, false 로 지정
	...
	$(document).ready(function() {
		...
		$('#btnMSave').click(function(){	 //저장
			...
			if(cnt > 0){
				if(confirm("저장 하시겠습니까?")){
					$.ajax({
						  url : '/ctms/v01/insertIRBBasicInfo.do' ,//변경 /ctms/e01/
						  type: 'post',
						  contentType: "application/json; charset=UTF-8",
		...
		$('#btnG1Save').click(function(){	 //저장
			...
			if(cnt > 0){
				if(confirm("저장 하시겠습니까?")){
					$.ajax({
						  url : '/ctms/v01/insertIRBCttpcInfo.do' ,//변경 /ctms/e01/
						  type: 'post',
						  contentType: "application/json; charset=UTF-8",
						  data : JSON.stringify(arJson),
						  success : function(data, textStatus, jqXHR) {
		...
		$('#btnG2Save').click(function(){	 //저장
			...
			if(cnt > 0){
				if(confirm("저장 하시겠습니까?")){
					$.ajax({
						  url : '/ctms/v01/insertIRBDlbrtctInfo.do' ,//변경 /ctms/e01/
						  type: 'post',
						  contentType: "application/json; charset=UTF-8",
						  data : JSON.stringify(arJson),
						  success : function(data, textStatus, jqXHR) {
		...
		$('#btnG3Save').click(function(){	 //저장
			...
			if(cnt > 0){
				if(confirm("저장 하시겠습니까?")){
					$.ajax({
						  url : '/ctms/v01/insertIRBRsrcctInfo.do' ,//변경 /ctms/e01/
						  type: 'post',
						  contentType: "application/json; charset=UTF-8",
						  data : JSON.stringify(arJson),
						  success : function(data, textStatus, jqXHR) {
...
// 								  AUIGrid.setProperty("#grid_wrap3", "editable" , false ); 
		...
		$('#btnG4Save').click(function(){	 //저장
			...
			if(cnt > 0){
				if(confirm("저장 하시겠습니까?")){
					$.ajax({
						  url : '/ctms/v01/insertIRBDlbrtInfo.do' ,//변경 /ctms/e01/
						  type: 'post',
						  contentType: "application/json; charset=UTF-8",
						  data : JSON.stringify(arJson),
						  success : function(data, textStatus, jqXHR) {
...
// 								  AUIGrid.setProperty("#grid_wrap4", "editable" , false ); 
		...
		$('#btnG5Save').click(function(){	 //저장
			...
			if(cnt > 0){
				if(confirm("저장 하시겠습니까?")){
					$.ajax({
						  url : '/ctms/v01/insertIRBSaeInfo.do' ,//변경 /ctms/e01/
						  type: 'post',
						  contentType: "application/json; charset=UTF-8",
						  data : JSON.stringify(arJson),
						  success : function(data, textStatus, jqXHR) {
...
// 								  AUIGrid.setProperty("#grid_wrap5", "editable" , false ); 
		...
		$('#btnG6Save').click(function(){	 //저장
			...
			if(cnt > 0){
				if(confirm("저장 하시겠습니까?")){
					$.ajax({
						  url : '/ctms/v01/insertIRBInfoInfo.do' ,//변경 /ctms/e01/
						  type: 'post',
						  contentType: "application/json; charset=UTF-8",
						  data : JSON.stringify(arJson),
						  success : function(data, textStatus, jqXHR) {
...
<body>
<c:import url="/com/topHeader.do?MODULE_CODE=CTMS&MENU_ID=CTMV0101&UPPER_MENU_ID=CTMV" charEncoding="utf-8"/> <!-- 변경 CTME010 -->
<c:import url="/com/lnb.do?MODULE_CODE=CTMS&MENU_ID=CTMV0101&UPPER_MENU_ID=CTMV" charEncoding="utf-8"/> <!-- 변경 CTME010 -->
<div id="wrap">
    ...
    <section id="mainCon">
        <div class="mainConInner">
            ...
            <article class="mainTitBox">
                <h3>IRB Info 과제</h3><!-- 변경 IRB Info 전체 -->
