...
var _user = {
	...
	var g_insttList   ; //연락처 구분코드
	var g_comCode1List; //연락처 구분코드
	var g_comCode2List; //심의비 구분1
	var g_comCode3List; //심의비 구분2
	var g_comCode4List; //계산서 종류
	var g_comCode5List; //심의구분

	var g_TaskSn   = "45";
	var g_TaskNo   = "CJ_A02_138";
	var g_updateYn = 'N';
	var n_rowMSelect;
	var n_rowSelect;
	    		   ...
	    		   ,{
	    			...
	    			, visible : true
	      			, labelFunction : function(  rowIndex, columnIndex, value, headerText, item ) { 
						...
						for(var i=0; me.columnLayout[3].editRenderer.list.length > i; i++) {
							if(me.columnLayout[3].editRenderer.list[i]['INSTT_NAME'] == value) {
								retStr = me.columnLayout[3].editRenderer.list[i]['INSTT_NAME'];
								break;
							}
						}
	    			...
	    			, editRenderer : {
	    				...
	    				listTemplateFunction : function(rowIndex, columnIndex, text, item, dataField, listItem) {
	    					...
	    					html += '<span style="display:inline-block;">' + listItem["INSTT_CODE"] + '</span>';
	    					html += '<span style="display:inline-block;">' + listItem["INSTT_NAME"] + '</span>';
	    					html += '<span style="display:inline-block;">' + listItem["TELF1"] + '</span>';
	    					html += '</div>';
	    					return html;
	    				}
	    			  }
				...
				AUIGrid.bind(me.id, 'selectionChange', function(e) {
					...
					if(selectedItems.length > 0) {
						...
						if(oldSelectedItemInfo && !isSeletionForceFlag) {
							...
							console.log("editRows : "+editRows+"     "+g_deleteChange);
...
// 					checkSelection();
			 		...
			 		$.ajax({
			 		    ...
			 		    success:function(data){
			 		    	if(data.success) {
			 		    		...
			 		    		me.columnLayout[3].editRenderer.list = data.insttlist;
			 		    		...
			 		    		myGridSub2.columnLayout[10].editRenderer.list = data.code4list; //계산서 종류 구분   CTMS010
			 		    		myGridSub3.columnLayout[5].editRenderer.list  = data.code4list; //계산서 종류 구분   CTMS010
			  ...
			  load: function(v1, v2) {
			 		...
			 		var searchArr = {'INSTT_NM' :$("#insttNm").val()};
	    		   ...
	    		   ,{
	    			...
	    			, labelFunction : function(  rowIndex, columnIndex, value, headerText, item ) { 
						...
						for(var i=0; me.columnLayout[5].editRenderer.list.length > i; i++) {
							if(me.columnLayout[5].editRenderer.list[i]['CODE'] == value) {
                  ...
                  ,{
 	    			...
 	    			, renderer : {
		 					...
		 					onclick : function(rowIndex, columnIndex, value, item){
		 						 ...
		 						 if(g_grid4Update == "Y"){
		 						 	mkLayerPopupOpen("/DMCJ1105.do", param);
		 						 }
		 					}
		 			  }
 	    		   }
...
*/
	...
	function accHeader(id){
		...
		if(id == "grid2"){
			if(!classGrid2){
				console.log(classGrid2+"  getGridUpdateCheck("+grid2+") : "+getGridUpdateCheck(id));
				if(g_grid2 == "Y"){
		...
		console.log(id+" ::: "+classGrid1+"  "+classGrid2+"   "+classGrid3+"   "+classGrid4+"   "+classGrid5);
...
console.log("rows : "+rows);
			if(rows > 0 ){
				...
				var editCnt = added.length + edited.length + remove.length;
				console.log("editCnt : "+editCnt);
				return editCnt;
			}
			return 0;
		}
	...
	$(document).ready(function() {
		...
		$('#btnMAddrow').click(function(){	 //행추가
			console.log("getUpdateCheck() : ["+getUpdateCheck()+"]");
			if(getUpdateCheck() > 0){
		...
		<div class="mainConInner">
            ...
            <section class="conBox100 conBox">
                <div class="conBoxInner">
                   ...
                   <!-- 컨텐츠박스 시작-->
                    <section class="conBox100 conBox" style="padding-top:0px;">
                            ...
                            <article>
                                <ul id="acdMenu02">
                                    ...
                                    <!-- 아코디언 메뉴 리스트 시작 -->
                                    <li class="acdMenuLst acdMenuLst02"><a class="acdMenuLik close" id="grid5" onclick='javascript:accHeader(this.id)'>e-IRB 정보</a>
                                        <div class="acdMenuCts acdMenuCts02 close">
