...
public class Globals {
	...
	//판테온 메시지
	public static final String PANTHEON_BIZ_MESSAGE = "PANTHEON_BIZ_MESSAGE";
	
	//판테온 읽기, 쓰기 에러 메시지
	public static final String PANTHEON_READ_WRITE_MESSAGE = "PANTHEON_READ_WRITE_MESSAGE";
