...
public class CTMV01Controller {
	 ...
	 * @return
	 */
	@RequestMapping(value="/ctms/v01/CTMV0101.do")
	public String CTMV0101(HttpServletRequest request, HttpServletResponse response, @RequestParam Map<String, String> map,
			ModelMap model) throws Exception{
		model.addAttribute("TASK_SN", "45");
		model.addAttribute("TASK_NO", "CJ_A02_138");
		model.addAttribute("SCREEN_ID", "CTMV0101");
		return "/pantheon/ctms/v01/CTMV0101";
	}
	 ...
	 * @return
	 */
	@RequestMapping(value="/ctms/v01/selectIRBInitInfo.do", method=(RequestMethod.POST))
	 ...
	 * @return
	 */
	@RequestMapping(value="/ctms/v01/selectIRBBasicInfoList.do", method=(RequestMethod.POST))
	 ...
	 * @return
	 */
	@RequestMapping(value="/ctms/v01/selectIRBCttpcList.do", method=(RequestMethod.POST))
	 ...
	 * @return
	 */
	@RequestMapping(value="/ctms/v01/selectIRBDlbrtctList.do", method=(RequestMethod.POST))
	 ...
	 * @return
	 */
	@RequestMapping(value="/ctms/v01/selectIRBRsrcctist.do", method=(RequestMethod.POST))
	 ...
	 * @return
	 */
	@RequestMapping(value="/ctms/v01/selectIRBDlbrtList.do", method=(RequestMethod.POST))
	 ...
	 * @return
	 */
	@RequestMapping(value="/ctms/v01/selectIRBSaeList.do", method=(RequestMethod.POST))
	 ...
	 * @return
	 */
	@RequestMapping(value="/ctms/v01/selectIRBInfoList.do", method=(RequestMethod.POST))
	 ...
	 * @return
	 */
	@RequestMapping(value="/ctms/v01/insertIRBBasicInfo.do", method=(RequestMethod.POST))
	 ...
	 * @return
	 */
	@RequestMapping(value="/ctms/v01/insertIRBCttpcInfo.do", method=(RequestMethod.POST))
	 ...
	 * @return
	 */
	@RequestMapping(value="/ctms/v01/insertIRBDlbrtctInfo.do", method=(RequestMethod.POST))
	 ...
	 * @return
	 */
	@RequestMapping(value="/ctms/v01/insertIRBRsrcctInfo.do", method=(RequestMethod.POST))
	 ...
	 * @return
	 */
	@RequestMapping(value="/ctms/v01/insertIRBDlbrtInfo.do", method=(RequestMethod.POST))
	 ...
	 * @return
	 */
	@RequestMapping(value="/ctms/v01/insertIRBInfoInfo.do", method=(RequestMethod.POST))
	 ...
	 * @return
	 */
	@RequestMapping(value="/ctms/v01/insertIRBSaeInfo.do", method=(RequestMethod.POST))
