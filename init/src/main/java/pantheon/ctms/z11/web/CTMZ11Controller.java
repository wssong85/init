...
@Controller
public class CTMZ11Controller {
	
	@Resource(name="CTMZ11Service")
	private CTMZ11Service ctmz11Service;
	...
	@RequestMapping(value="/ctms/z11/CTMZ1101.do")
	public String CTMZ1101(HttpServletRequest request, HttpServletResponse seponse, @RequestParam Map<String, String> map,
			ModelMap model) throws Exception {
		model.addAttribute("result", map);
		return "/pantheon/ctms/z11/CTMZ1101";
	}
	 ...
	 */
	//@IncludedInfo(name="Protocol 리스트 화면", order = 7020 ,gid = 110)
	@RequestMapping(value="/ctms/z11/CTMZ1102.do")
	public String CTMZ1102(HttpServletRequest request, HttpServletResponse seponse, @RequestParam Map<String, String> map,
			ModelMap model) throws Exception {
		return "/pantheon/ctms/z11/CTMZ1102";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/ctms/z11/selectTitleList.do", method=(RequestMethod.POST))
	public @ResponseBody Map<String , Object> selectTitleList(HttpServletRequest request, HttpServletResponse response, 
		...
		try {
			list = ctmz11Service.selectTitleList(map); //방문목적 항목 조회
	 ...
	 * @return
	 */	
	@RequestMapping(value="/ctms/z11/selectPreTrialVisitReport.do", method=(RequestMethod.POST))
	public @ResponseBody Map<String , Object> selectPreTrialVisitReport(HttpServletRequest request, HttpServletResponse response, 
		...
		try {
			...
			list = ctmz11Service.selectPreTrialVisitReport(map);	
	 ...
	 * @return
	 */	
	@RequestMapping(value="/ctms/z11/selectVisitReport1.do", method=(RequestMethod.POST))
	public @ResponseBody Map<String , Object> selectVisitReport1(HttpServletRequest request, HttpServletResponse response, 
		...
		try {
			...
			list = ctmz11Service.selectVisitReport1(map);
	 ...
	 * @return
	 */	
	@RequestMapping(value="/ctms/z11/selectVisitReport2.do", method=(RequestMethod.POST))
	public @ResponseBody Map<String , Object> selectVisitReport2(HttpServletRequest request, HttpServletResponse response, 
		...
		try {
			...
			list = ctmz11Service.selectVisitReport2(map);
	 ...
	 * @return
	 */	
	@RequestMapping(value="/ctms/z11/selectItemReport.do", method=(RequestMethod.POST))
	public @ResponseBody Map<String , Object> selectItemReport(HttpServletRequest request, HttpServletResponse response, 
		...
		try {
			...
			list = ctmz11Service.selectItemReport(map);		
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/ctms/z11/insertPreTrialVisitReport.do", method=(RequestMethod.POST))
	public @ResponseBody Map<String, Object> insertMonitoringPlanReport(HttpServletRequest request, HttpServletResponse response, 
		...
		Map<String, Object> result = new HashMap<String, Object>();	
		try {
			ctmz11Service.insertPreTrialVisitReport(list);
			result.put("success", true);
		} catch (Exception e) {
			result.put("success", false);
			result.put("message", e.getLocalizedMessage());
	 ...
	 * @return
	 */
	@RequestMapping(value="/ctms/z11/selectApprovalInfo.do", method=(RequestMethod.POST))
	public @ResponseBody Map<String , Object> selectApprovalInfo(HttpServletRequest request, HttpServletResponse response, 
		...
		try {
			list = ctmz11Service.selectApprovalInfo(map);
			result.put("success", true);
			result.put("result", list);	
			result.put("param", CommonService.selectQueryDataList(param));
		} catch (Exception e) {
	 ...
	 * @param response
	 */	
	@RequestMapping(value="/ctms/z11/insertApprovalEmail.do", method=(RequestMethod.POST))
