...
@Controller
public class CTMZ07Controller {
	
	@Resource(name="CTMZ07Service")
	private CTMZ07Service ctmz07Service;
	...
	@RequestMapping(value="/ctms/z07/CTMZ0701.do")
	public String CTMZ0701(HttpServletRequest request, HttpServletResponse seponse, @RequestParam Map<String, String> map,
			ModelMap model) throws Exception {
		model.addAttribute("result", map);
		return "/pantheon/ctms/z07/CTMZ0701";
	}
	 ...
	 */
	//@IncludedInfo(name="Protocol 리스트 화면", order = 7020 ,gid = 110)
	@RequestMapping(value="/ctms/z07/CTMZ0702.do")
	public String CTMZ0702(HttpServletRequest request, HttpServletResponse seponse, @RequestParam Map<String, String> map,
			ModelMap model) throws Exception {
		return "/pantheon/ctms/z07/CTMZ0702";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/ctms/z07/selectTitleList.do", method=(RequestMethod.POST))
	public @ResponseBody Map<String , Object> selectTitleList(HttpServletRequest request, HttpServletResponse response, 
		...
		try {
			list = ctmz07Service.selectTitleList(map); //방문목적 항목 조회
	 ...
	 * @return
	 */	
	@RequestMapping(value="/ctms/z07/selectPreTrialVisitReport.do", method=(RequestMethod.POST))
	public @ResponseBody Map<String , Object> selectPreTrialVisitReport(HttpServletRequest request, HttpServletResponse response, 
		...
		try {
			...
			list = ctmz07Service.selectPreTrialVisitReport(map);	
	 ...
	 * @return
	 */	
	@RequestMapping(value="/ctms/z07/selectVisitReport1.do", method=(RequestMethod.POST))
	public @ResponseBody Map<String , Object> selectVisitReport1(HttpServletRequest request, HttpServletResponse response, 
			@RequestParam Map<String, String> map) throws Exception {
			Map<String, Object> result = new HashMap<String, Object>();
			List<Map<String, Object>> list = null;
		...
		try {
			...
			list = ctmz07Service.selectVisitReport1(map);
	 ...
	 * @return
	 */	
	@RequestMapping(value="/ctms/z07/selectVisitReport2.do", method=(RequestMethod.POST))
	public @ResponseBody Map<String , Object> selectVisitReport2(HttpServletRequest request, HttpServletResponse response, 
			@RequestParam Map<String, String> map) throws Exception {
			Map<String, Object> result = new HashMap<String, Object>();
			List<Map<String, Object>> list = null;
		...
		try {
			...
			list = ctmz07Service.selectVisitReport2(map);
			
			if(map.containsKey("FROM_VISIT_DE") && map.containsKey("TO_VISIT_DE")){
	 ...
	 * @return
	 */	
	@RequestMapping(value="/ctms/z07/selectItemReport.do", method=(RequestMethod.POST))
	public @ResponseBody Map<String , Object> selectItemReport(HttpServletRequest request, HttpServletResponse response, 
		...
		try {
			...
			list = ctmz07Service.selectItemReport(map);		
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/ctms/z07/insertPreTrialVisitReport.do", method=(RequestMethod.POST))
	public @ResponseBody Map<String, Object> insertMonitoringPlanReport(HttpServletRequest request, HttpServletResponse response, 
		...
		Map<String, Object> result = new HashMap<String, Object>();	
		try {
			ctmz07Service.insertPreTrialVisitReport(list);
			result.put("success", true);
		} catch (Exception e) {
			result.put("success", false);
			result.put("message", e.getLocalizedMessage());
	 ...
	 * @return
	 */
	@RequestMapping(value="/ctms/z07/selectApprovalInfo.do", method=(RequestMethod.POST))
	public @ResponseBody Map<String , Object> selectApprovalInfo(HttpServletRequest request, HttpServletResponse response, 
		...
		try {
			list = ctmz07Service.selectApprovalInfo(map);
			result.put("success", true);
			result.put("result", list);	
			result.put("param", CommonService.selectQueryDataList(param));
		} catch (Exception e) {
	 ...
	 * @param response
	 */	
	@RequestMapping(value="/ctms/z07/insertApprovalEmail.do", method=(RequestMethod.POST))
	public @ResponseBody Map<String, Object> sendMail(HttpServletRequest request, HttpServletResponse response,
		...
		map.put("URL", req.getScheme() + "://52.2.72.215:8080/sample/list.do");
